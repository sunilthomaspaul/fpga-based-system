...
BEGIN OS
 ...
 PARAMETER OS_SOURCE_LOCATION = C:\Xilinx\12.3\ISE_DS\EDK\sw\lib\bsp\uCOS-II_v2_90_a\src\uC_OS-II
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = PS2_Keyboard
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ps2
 PARAMETER DRIVER_VER = 2.00.a
 PARAMETER HW_INSTANCE = PS2_Mouse
END
