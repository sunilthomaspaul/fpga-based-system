...
{    
    ...
    Reg64Value_o.Upper = (INT32U)pmsg;                           
    Reg64Value_o.Lower |= HWRTOS_MBOX_CREATE;
    OS_ENTER_CRITICAL();    
...
void  *OSMboxPend (INT8U pevent, INT16U timeout, INT8U *perr)           // SW/HW RTOS                                 
{
    ...
    Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_MBOX_PEND_STAT;
    OS_ENTER_CRITICAL();    
    HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);       
    HWRTOS_ReadSlaveReg4(hwrtos_addrp, &Reg64Value_i);               
    OS_EXIT_CRITICAL();    
...
INT8U  OSMboxPost (INT8U pevent, void *pmsg)          // SW/HW RTOS                                                   
{
    Xuint64 Reg64Value_o;
    Xuint64 Reg64Value_i;  
...
#endif       
    Reg64Value_o.Lower |= pevent;    
    Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_MBOX_POST;    
    Reg64Value_o.Upper = (INT32U)pmsg;
    OS_ENTER_CRITICAL();
    HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                           
    HWRTOS_ReadSlaveReg4(hwrtos_addrp, &Reg64Value_i);                     
