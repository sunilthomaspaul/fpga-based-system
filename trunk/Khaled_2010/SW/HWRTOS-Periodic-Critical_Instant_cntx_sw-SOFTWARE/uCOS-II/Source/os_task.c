                        ...
                        INT16U   period)                 // SW/HW RTOS                                              
{
    ...
    Reg64Value_o.Upper |= name;                   
    Reg64Value_o.Upper = (Reg64Value_o.Upper << 16) | period;          
    Reg64Value_o.Lower |= id;                   
    Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | prio;      
    Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TSK_CREATE_PERIODIC;                
