-- ************************************************************************
-- $Id: coregen_comp_defs.vhd,v 1.1 2005/08/23 19:22:55 kuehner Exp $
-- ************************************************************************
 ...
 COMPONENT async_fifo_v4_0 
    GENERIC (c_enable_rlocs         : INTEGER := 0;
       ...
       PORT (din            : IN STD_LOGIC_VECTOR(c_data_width-1 DOWNTO 0) := (OTHERS => '0');
        ...
        --     wr_count       : OUT STD_LOGIC_VECTOR(c_wr_count_width-1 DOWNTO 0); --optional. default=true
        --     rd_count       : OUT STD_LOGIC_VECTOR(c_rd_count_width-1 DOWNTO 0); --optional. default=false
