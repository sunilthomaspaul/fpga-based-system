...
//
//////////////////////////////////////////////////////////////////////////////
// Filename:          C:\solmaz\CMC\AP1100_design\baseline-ap1100_CMC\drivers\slave_regs4_v1_00_a\src\slave_regs4_selftest.c
// Version:           1.00.a
// Description:       Contains a diagnostic self-test function for the slave_regs4 driver
...
XStatus SLAVE_REGS4_SelfTest(void * baseaddr_p)
{
   ...
   SLAVE_REGS4_mWriteSlaveReg0(baseaddr, 0);
   Reg32Value = SLAVE_REGS4_mReadSlaveReg0(baseaddr);
   ...
   SLAVE_REGS4_mWriteSlaveReg1(baseaddr, 1);
   Reg32Value = SLAVE_REGS4_mReadSlaveReg1(baseaddr);
   ...
   SLAVE_REGS4_mWriteSlaveReg2(baseaddr, 2);
   Reg32Value = SLAVE_REGS4_mReadSlaveReg2(baseaddr);
   ...
   SLAVE_REGS4_mWriteSlaveReg3(baseaddr, 3);
   Reg32Value = SLAVE_REGS4_mReadSlaveReg3(baseaddr);
