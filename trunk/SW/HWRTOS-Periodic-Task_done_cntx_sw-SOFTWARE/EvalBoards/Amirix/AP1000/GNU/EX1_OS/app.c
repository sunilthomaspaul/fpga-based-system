...
{       
    ...
    //TxMbox  = OSMboxCreate((void *)0);
     ...
     OSTaskCreatePeriodic(AppTaskSecond,
                   ...
                   OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR,
                   0x32,
                   100);                             //Character '2' as application Second task name with 100 ticks period        
     ...
     OSTaskCreatePeriodic(AppTaskTenth,
                   ...
                   OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR,
                   0x41,
                   100);                             //Character 'A' as application Tenth task name with 100 ticks period                                                         
