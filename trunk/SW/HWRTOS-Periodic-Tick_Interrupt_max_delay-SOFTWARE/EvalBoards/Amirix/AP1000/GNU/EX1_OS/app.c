...
{              
    ...
    Xuint64 Reg64Value_i4, Reg64Value_i5, Reg64Value_i6, Reg64Value_i7; 
         	 
	Reg64Value_o.Lower = 0;
	Reg64Value_o.Upper = 0;
	Reg64Value_i4.Lower = 0;
	Reg64Value_i4.Upper = 0;
	Reg64Value_i5.Lower = 0;
	Reg64Value_i5.Upper = 0;
	Reg64Value_i6.Lower = 0;
	Reg64Value_i6.Upper = 0;
	Reg64Value_i7.Lower = 0;
	Reg64Value_i7.Upper = 0; 	 
	*/	 
    ...
    OS_CPU_SR  cpu_sr;
     ...
     OSTaskCreatePeriodic(AppTaskTenth,
                   ...
                   OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR,
                   0x41,
                   0x0000);                          //Character 'A' as application Tenth task name not periodic                                
             	        
	 /*
     Reg64Value_o.Lower = 0;                         
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL(); 
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                    
     HWRTOS_ReadSlaveReg5(hwrtos_addrp, &Reg64Value_i5);         
     HWRTOS_ReadSlaveReg6(hwrtos_addrp, &Reg64Value_i6);                
     HWRTOS_ReadSlaveReg4(hwrtos_addrp, &Reg64Value_i4);        
     OS_EXIT_CRITICAL();     
     xil_printf("\r\n prio 0 TCB L= %lX \r\n", Reg64Value_i4.Lower); 
     xil_printf("\r\n prio 0 TCB U= %lX \r\n", Reg64Value_i4.Upper); 
     xil_printf("\r\n prio 0 TCB L= %lX \r\n", Reg64Value_i5.Lower); 
     ...
     Reg64Value_o.Lower = 0;              
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x01;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL();
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                   
     ...
     Reg64Value_o.Lower = 0;         
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x02;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL();
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                   
     ...
     Reg64Value_o.Lower = 0;         
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x03;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL();
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                  
     ...
     Reg64Value_o.Lower = 0;        
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x04;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL(); 
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                   
     ...
     Reg64Value_o.Lower = 0;        
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x05;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL();
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                
     ...
     Reg64Value_o.Lower = 0;        
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x06;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL(); 
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                   
     ...
     Reg64Value_o.Lower = 0;        
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x07;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL(); 
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                 
     ...
     Reg64Value_o.Lower = 0;         
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x08;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL();
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                   
     ...
     Reg64Value_o.Lower = 0;       
     Reg64Value_o.Lower |= 0x01;                
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x09;           
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | 0x00;    
     Reg64Value_o.Lower = (Reg64Value_o.Lower << 8) | HWRTOS_TEST;    
     OS_ENTER_CRITICAL(); 
     HWRTOS_WriteSlaveReg0(hwrtos_addrp, &Reg64Value_o);                    
...
{	      
    ...
    while (1) {	          
        ...
        sw_tmr_value = BSP_SwTmrStop() - overhead;				                            
		xil_printf("\r\n Task 10 HW timer loop delay = %ld \r\n", sw_tmr_value);					
    }
}
