...
# Project:C:\Baseline_9_Working_Folder\K-new-base\system.xmp
#
...
# C:\Baseline_9_Working_Folder\K-new-base\system.mhs
# The software specification of the system is in file :
# C:\Baseline_9_Working_Folder\K-new-base\system.mss
...
ppc405_ppcjtag_chain_libsclean:
...
EX1_OS_program: $(EX1_OS_OUTPUT) 

$(EX1_OS_OUTPUT) : $(EX1_OS_SOURCES) $(EX1_OS_HEADERS) $(EX1_OS_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/ex1_os_compiler.opt
	@mkdir -p $(EX1_OS_OUTPUT_DIR) 
	$(EX1_OS_CC) $(EX1_OS_CC_OPT) $(EX1_OS_SOURCES) -o $(EX1_OS_OUTPUT) \
	$(EX1_OS_OTHER_CC_FLAGS) $(EX1_OS_INCLUDES) $(EX1_OS_LIBPATH) \
	$(EX1_OS_CFLAGS) $(EX1_OS_LFLAGS) 
	$(EX1_OS_CC_SIZE) $(EX1_OS_OUTPUT) 
	@echo ""
...
$(PPC405_I_BOOTLOOP): $(PPC405_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(PPC405_BOOTLOOP) $(PPC405_I_BOOTLOOP)

$(PPC405_PPCJTAG_CHAIN_BOOTLOOP): $(PPC405_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(PPC405_BOOTLOOP) $(PPC405_PPCJTAG_CHAIN_BOOTLOOP)
