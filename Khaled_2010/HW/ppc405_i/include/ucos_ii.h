...
*/
    ...
    OS_STK          *OSStkPtr[16], **OSCurPrioStkPtr, **OSHiPrioStkPtr;       // SW/HW RTOS                           
...
OS_EXT  INT8U             tick_time;
OS_EXT  INT32U            tick_int_time;
OS_EXT  INT8U             task_create_time;
OS_EXT  INT8U             time_delay_time;
OS_EXT  INT8U             sema4_create_time;
OS_EXT  INT8U             sema4_pend_time;
OS_EXT  INT8U             sema4_pend_stat_time;
OS_EXT  INT8U             sema4_post_time;
OS_EXT  INT8U             mbox_crt_time;
OS_EXT  INT8U             mbox_pend_time;
OS_EXT  INT8U             mbox_pend_stat_time;
OS_EXT  INT8U             mbox_post_time;
OS_EXT  INT8U             os_start_time;
...
// SW/HW RTOS
OS_EXT  INT8U             OSTmrSem;                 /* Sem. used to gain exclusive access to timers    */
OS_EXT  INT8U             OSTmrSemSignal;           /* Sem. used to signal the update of timers        */
...
INT8U     OSMboxCreate                (void            *pmsg);         // SW/HW RTOS                                  
...
INT8U         OSMboxPost              (INT8U            pevent,
                                       void            *pmsg);         // SW/HW RTOS
#endif
...
INT8U         OSSemCreate             (INT16U           cnt);         // SW/HW RTOS                                   
...
INT8U         OSSemPost               (INT8U            pevent);     // SW/HW RTOS
...
#if OS_TASK_CREATE_EXT_EN > 0
INT8U         OSTaskCreatePeriodic         (void           (*task)(void *p_arg),
                                       void            *p_arg,
                                       OS_STK          *ptos,
                                       INT8U            prio,
                                       INT16U           id,
