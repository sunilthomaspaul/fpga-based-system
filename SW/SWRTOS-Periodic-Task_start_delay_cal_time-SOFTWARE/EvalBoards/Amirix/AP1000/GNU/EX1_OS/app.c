...
{	    
    ...
    while (1) {	           
           ...
           //BSP_SwTmrStart();       
		   rem_time = (75*iteration++) - ((BSP_CnotTmrRead() - overhead2) / 800000);		   
...
{	
    ...
    while (1) {	 
           ...
           //BSP_SwTmrStart();  
		   rem_time = (150*iteration++) - ((BSP_CnotTmrRead() - overhead2) / 800000);
...
{	
    ...
    while (1) {	
           ...
           //BSP_SwTmrStart();  
           rem_time = (300*iteration++) - ((BSP_CnotTmrRead() - overhead2) / 800000);
